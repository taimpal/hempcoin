    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("hempcoin") + " - " + tr("Purse"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a hempcoin address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your hempcoin addresses to prove you own them"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("hempcoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to hempcoin network", "", count));
}
...
{
    QString strTitle = tr("hempcoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid hempcoin address or malformed URI parameters."),
