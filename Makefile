...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Fri Jul 25 12:04:34 2014
# Project:  hempcoin-qt.pro
# Template: app
# Command: c:/QT/4.8.5/bin/qmake.exe USE_IPV6=- USE_UPNP=- -o Makefile hempcoin-qt.pro
#############################################################################
...
Makefile: hempcoin-qt.pro  ../../../../QT/4.8.5/mkspecs/default/qmake.conf ../../../../QT/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_IPV6=- USE_UPNP=- -o Makefile hempcoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/COINSS/pure-hompcoin/pure/hempcoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/COINSS/pure-hompcoin/pure/hempcoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/COINSS/pure-hompcoin/pure/hempcoin/src/leveldb/libleveldb.a: FORCE
	cd C:/COINSS/pure-hompcoin/pure/hempcoin/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/COINSS/pure-hompcoin/pure/hempcoin/src/leveldb/libleveldb.a && ranlib C:/COINSS/pure-hompcoin/pure/hempcoin/src/leveldb/libmemenv.a
